...
LAATSTE_UPDATE = "23 september 2026"
VERSIE = "3.0.11"
...
# --- Frosted Glass Achtergrond CSS met Slider Variabele ---
...
if st.session_state.get("ingelogd") and st.session_state.get("rol") == "docent":
    ...
    <script>
        ...
        function jump(e) {
            if(e && e.type === "keydown" && e.code === "Space") e.preventDefault(); // Voorkom scrollen
