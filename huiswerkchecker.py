...
# 0. Paginainstellingen (Moet altijd als eerste!)
st.set_page_config(page_title="Huiswerkcontrole AK", page_icon="🗺️")
...
# Functie om de Picture of the Day op te halen (NU MET USER-AGENT!)
...
def haal_wikimedia_potd_url_op():
    ...
    # Wikimedia vereist dat we ons netjes identificeren
    headers = {
        'User-Agent': 'HuiswerkCheckerApp/1.0 (docent@voorbeeld.nl)'
    }
...
# CSS VOOR ACHTERGROND, BREEDTE EN LETTERTYPE
achtergrond_css = f"""
<style>
...
/* Maak de app en het invoervak breder (standaard is ca. 730px) */
.block-container {{
    max-width: 900px !important;
}}

/* Maak het lettertype over de hele linie iets groter */
html, body, p, li, label, .stMarkdown, .stChatInput textarea {{
